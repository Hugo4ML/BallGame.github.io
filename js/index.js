...
async function main() {
  ...
  */
  window.document.title = "(0.1.62) Simple project";
  ...
  for(let target = 0; target < targets.length; ++target) targets[target] = new Box(canvas, target * 0.25 + 0.0375 - 1.0, 0.75, 0.25 - 0.075, 0.125);
