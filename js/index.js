...
async function main() {
  ...
  */
  window.document.title = "(0.2.13) Simple project";
  ...
  let ball = new Box(canvas, Math.random() - 0.5140625, -0.025, 0.028125, /*0.028125*//*0.05*/0.03, (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches)? [1.0, 1.0, 1.0]: [0.0, 0.0, 0.0]);
