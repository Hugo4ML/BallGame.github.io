...
async function main() {
  ...
  */
  window.document.title = "(0.3.69) Simple project";
  ...
  setInterval(async function() {
    ...
    if(ballYSpeed > 0.0) ballYSpeed = (3.0/*0.975*/) / deltaTime;
    if(ballYSpeed < 0.0) ballYSpeed = -(3.0/*0.975*/) / deltaTime;
    ...
    while(bulletTime > 0.0) {
      ...
      } else if((-1.0 - ball.y) / ballYSpeed && (-1.0 - ball.y) / ballYSpeed < timeStep) {
