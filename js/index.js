...
async function main() {
  ...
  */
  window.document.title = "(0.1.74) Simple project";
  ...
  for(let target = 0; target < targets.length; ++target) targets[target] = new Box(canvas, (target * 0.25) % 2.125 + 0.017578125 - 1.0, /*1.0 - (0.03125 + 0.125) * ((target / 9.0) - (target / 9.0) % 1 + 1)*/1.0 - target * 0.02, 0.25 - 0.03515625, 0.125);
