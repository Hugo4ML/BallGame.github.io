...
async function main() {
  ...
  */
  window.document.title = "(0.1.63) Simple project";
  ...
  for(let target = 0; target < targets.length; ++target) targets[target] = new Box(canvas, target * 0.25 + 0.05 - 1.0, 1.0 - 0.0875, 0.25 - 0.1, 0.125);
