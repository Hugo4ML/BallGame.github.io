...
async function main() {
  ...
  */
  window.document.title = "(0.2.16) Simple project";
  ...
  let ballYSpeed = -0.0005625;//0.001;
  ...
  let ball = new Box(canvas, Math.random() - 0.5140625, -0.025, 0.028125, /*0.028125*//*0.05*/0.0281249, (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches)? [1.0, 1.0, 1.0]: [0.0, 0.0, 0.0]);
  ...
  setInterval(async function() {
    ...
    //Move ball.
    {
      ...
      while(time > 0.0) {
        ...
        const timeSteps = [noWall, /*leftWall, rightWall, */topWall, bottomWall];
