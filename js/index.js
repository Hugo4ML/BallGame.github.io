...
async function main() {
  ...
  */
  window.document.title = "(0.1.70) Simple project";
  ...
  for(let target = 8; target < 15; ++target) targets[target] = new Box(canvas, (target - 8) * 0.25 + 0.03515625 - 1.0, 1.0 - (0.0625 - 0.125) * 2.0, 0.25 - 0.0703125, 0.125);
