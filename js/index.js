...
async function main() {
  ...
  */
  window.document.title = "(0.1.79) Simple project";
  ...
  for(let target = 0; target < targets.length; ++target) targets[target] = new Box(canvas, (target * 0.25) % 1.875 + 0.017578125 - 1.0, 1.0 - (0.03125 + 0.125) * ((target / 7.5) - (target / 7.5) % 1 + 1), 0.25 - 0.03515625, 0.125);
